// Synchronous pure-TypeScript SHA-256 (FIPS 180-4). The simulation hashes state on every commit in
// Node and every browser; a single implementation removes runtime crypto API differences
// (WebCrypto is asynchronous) from the determinism surface.
